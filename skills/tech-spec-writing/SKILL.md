...
- **The component breakdown and the object model** — mandated sections:
  their definitions and the object model's naming-authority rule live in
  `docs/documentation-structure.md` and `standards/coding-standards.md`
  ("The object model is the naming authority") — link them, don't
  restate them.
