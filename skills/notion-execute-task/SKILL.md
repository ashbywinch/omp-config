...
### 1. Load Task Details
Read the task page in Notion (see `skill://notion-workbook`). Review deliverables, success criteria, dependencies.

### 2. Verify Dependencies
Check each dependency's Status property.

### 3. Start Execution
Update Status to **"In Progress"** via PATCH (see `skill://notion-workbook`).
...
See `skill://notion-workbook` for PATCH syntax and query patterns.
