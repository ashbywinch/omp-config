...
- `docs/` standards triplet, checked by PR-Agent:
  ...
  - `docs/testing-standards.md` — tests mirror module paths, deterministic (no wall-clock, network, or order dependence; fake RNG fixed-seeded, real RNG never seeded), assert behavior not implementation, DI fakes over `unittest.mock.patch`.
