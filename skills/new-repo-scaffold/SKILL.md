...
- [ ] dependabot: weekly for package ecosystem + `github-actions`, patch/minor grouped per ecosystem, auto-merge workflow present (majors and action bumps stay human)
