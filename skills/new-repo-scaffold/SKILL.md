...
- [ ] dependabot: weekly for package ecosystem + `github-actions`, all bumps grouped per ecosystem (patch/minor auto-merge on green CI; majors grouped but human-reviewed; action bumps ungrouped — SHA-pin treatment)
