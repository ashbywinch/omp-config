...
**Standards copied into every repo** — this is the one authoritative list:
  - `docs/coding-standards.md` — code conventions (language-agnostic).
  - `docs/testing-standards.md` — testing, DI, typechecking.
  - `docs/writing-documentation.md` — documentation quality rules.
  - `docs/documentation-structure.md` — required doc set and folder structure.
  - `docs/ux-standards.md` — UX principles.
  The language layers below add toolchain-specific sections to the coding standard.
...
layer above and in the standards docs; the language layer is the toolchain
implementation of those rules for one stack. The pattern each layer covers:
